...
// ── 23) Živý incident 16.8. (karta -03): „zapni párování" + úspěšný ──────────
...
assert.strictEqual(
  ...
  false,
  '23a: úspěšný zigbee_permit_join legitimizuje „zapnul jsem párování" (repro incidentu 16.8.)',
);
...
assert.strictEqual(
  ...
  true,
  '23b: tvrzení „zapnul jsem párování" bez proběhlého permit_join = fabrikace',
);
...
assert.strictEqual(
  ...
  true,
  '23c: neúspěšný permit_join + tvrzení „zapnul jsem" = fabrikace (bridge offline)',
);

console.log('check-action-claim-guard: OK (23 scénářů)');
