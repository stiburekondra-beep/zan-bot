...
ZAN_BRIDGE_ENABLED=$(bashio::config 'zan_bridge_enabled')
ZAN_VOICE_URL=$(bashio::config 'zan_voice_url')
ZAN_VOICE_TOKEN=$(bashio::config 'zan_voice_token')
ZAN_VOICE_CHAT_ID=$(bashio::config 'zan_voice_chat_id')
...
export ZAN_BRIDGE_ENABLED
export ZAN_VOICE_URL
export ZAN_VOICE_TOKEN
export ZAN_VOICE_CHAT_ID
